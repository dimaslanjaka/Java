...
public class DateTime {
	...
	public static String getDate(String dateString, String dateFormat) {
		return getDate(new Date(dateString).getTime(), dateFormat);
	}
	...
	public static String getDate(Date todayWithZeroTime, String s) {
		return getDate(todayWithZeroTime.toString(), s);
	}
}