...
cc.Handler.OSAPIBASE_SHARE_RT = 10001
cc.Handler.OSAPIBASE_WEB_EVENT = 10002
cc.Handler.OSAPIBASE_WX_AUTHEN_RT = 10003
cc.Handler.OSAPIBASE_GPS_RT = 10004
cc.Handler.GAME_BASE_COM_CALLBACK = 10005
...
cc.GCDataForLuaType = cc.GCDataForLuaType or {}
cc.GCDataForLuaType.HTTP_ASY_RES_DATA = 0
cc.GCDataForLuaType.HTTP_BLOCK_RES_DATA = 1
cc.GCDataForLuaType.HTTP_SEND_DATA = 2

cc.MessageBoxType = cc.MessageBoxType or {}
cc.MessageBoxType.MESSAGE_ASK = 0
cc.MessageBoxType.MESSAGE_WORNING = 1
cc.MessageBoxType.MESSAGE_WORING_TIMER = 2
cc.MessageBoxType.MESSAGE_TIP = 3
cc.MessageBoxType.MESSAGE_BIG_TIP_TIMER = 4
cc.MessageBoxType.MESSAGE_TIMER = 5
cc.MessageBoxType.MESSAGE_TIP_TIMER = 6
cc.MessageBoxType.MESSAGE_ASK_TIMER = 7
cc.MessageBoxType.MESSAGE_ASK_CHANGE = 8
cc.MessageBoxType.MESSAGE_ASK_GET = 9
cc.MessageBoxType.MESSAGE_ASK_GGGM = 10
cc.MessageBoxType.MESSAGE_ASK_AUTO_GAME = 11



cc.GameViewEleTag = cc.GameViewEleTag or {}
cc.GameViewEleTag.TAG_TOP_UI = 0
cc.GameViewEleTag.TAG_TABLE_UI = 1
cc.GameViewEleTag.TAG_CLOCK_UI = 2
cc.GameViewEleTag.TAG_PLAYERGAME_INFO = 3
cc.GameViewEleTag.TAG_PLAYERINFO = 7
cc.GameViewEleTag.TAG_PLAYER_DETAIL = 11
cc.GameViewEleTag.TAG_ANI_ARROW = 15
cc.GameViewEleTag.TAG_UI_ANI_LAYER = 16
cc.GameViewEleTag.TAG_ROOM_INFO = 17
cc.GameViewEleTag.TAG_RANDOM_SIT = 18
cc.GameViewEleTag.TAG_CHATING = 19


cc.GameGCDataForLuaType = cc.GameGCDataForLuaType or {}
cc.GameGCDataForLuaType.DATA_SOCKET_SEND_MSG = 0
cc.GameGCDataForLuaType.DATA_SOCKET_REC_MSG = 1
cc.GameGCDataForLuaType.DATA_FOR_INTERACTIVE = 2

cc.HwLobbyLobbyEvent =
{
	LEID_FRIST_SHOW = 0,--第一次显示大厅
	LEID_SIGNIN = 1,--显示签到
	LEID_IMGBULL = 2,--显示图片公告
	LEID_BULL = 3,--显示公告
	LEID_FRIEND = 4,--显示好友
	LEID_SHOP = 5,--示商城(购买)
	LEID_SHARE = 6,--执行分享
	...
	LEID_BONUS = 8,--显示首充界面
	LEID_ALMS = 9,--救济
	LEID_FBLOGIN = 10,--执行FB登录
	LEID_KF = 11,--显示客服界面
	LEID_SET = 12,--显示设置界面
	LEID_RULE = 13,--显示规则界面
	LEID_CODE = 14,--显示兑换码界面
	LEID_FBAWARE = 15,--显示FB登录礼包
	LEID_EXAWARE = 16,--显示后台开分礼包
	LEID_AUTOGAME = 17,--自动进入游戏
	LEID_WHATSAPP = 18,--显示WhatsApp
	LEID_SHARE_ONEDAY = 19,--执行每日分享
	LEID_AWAED_CHANGE = 20,--奖品兑换界面
	LEID_SPREADER = 21,--显示推广界面
	LEID_ACTIVITY = 22,--显示活动界面
	LEID_PHONEBIND = 23,--显示手机绑定信息
	LEID_GWLB = 24,--显示官网礼包
	LEID_HPTIPS = 25,--好评提示
	LEID_MAIL = 26,--显示邮箱
	LEID_SEND_MONEY = 27,--显示赠送功能
	LEID_RANKING = 28,--显示排行功能
	LEID_SECOND_PWD = 29,--显示二级密码
	LEID_MORE_GAME = 30,--显示更多游戏
    LEID_VIP = 31,--显示VIP界面
    LEID_SHOW_WEB_PAGE = 99,--浏览器显示网页
    LEID_SHOW_WEB_VIEW = 100,--内嵌显示网页
    LEID_GWAPK = 101,--浏览器打开官网包地址
}

cc.HwLobbyCommEvent =
{
    LCCE_REFRESH_MONEY = 0,
	LCCE_ENTER_SMALL_GAME = 1,
	LCCE_EXIT_SMALL_GAME = 2,
}
