 ...
 */
public class JSONTokenerKeeped {
     ...
     *           called.
     */
    public JSONTokenerKeeped(String in) {
     ...
     */
    private JSONObjectKeeped readObject() throws JSONException {
        JSONObjectKeeped result = new JSONObjectKeeped();
